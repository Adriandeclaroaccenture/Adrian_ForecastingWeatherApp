...
//Weather Getting Data Coordinates
...
class WeatherManager {
    ...
    func getCurrentWeather(latitude: CLLocationDegrees, longtitude: CLLocationDegrees) async throws -> ResponseBody {
        ...
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/weather?lat=\(latitude)&lon=\(longtitude)&appid=\("96d28c208664698f6c02c4be0dba3e8f")") else {
